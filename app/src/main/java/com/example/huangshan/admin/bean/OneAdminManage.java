...
public class OneAdminManage implements Serializable {

    private String adminAccount;
    private String adminName;
    private String adminSex;
    private String adminAge;
    private String adminWorkYear;
    ...
    public String getAdminWorkYear() {
        return adminWorkYear;
    }

    public void setAdminWorkYear(String adminWorkYear) {
